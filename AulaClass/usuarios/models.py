...
class Curso(models.Model):
    ...
    def clean(self):
        ...
        # CORRECCIÓN DE EXPERTO: Usamos _id para evitar crash si no existe
        if not self.profesor_jefe_id:
...
class Asignatura(models.Model):
    ...
    def clean(self):
        ...
        # CORRECCIÓN DE EXPERTO: Usamos _id para evitar crash
        ...
        ya_existe = Asignatura.objects.filter(
            ...
            curso_id=self.curso_id # Usamos ID también aquí por seguridad
        ).exclude(id=self.id).exists()
